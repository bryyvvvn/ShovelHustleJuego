...
var object_data : objectData = preload("res://Assets/Recursos/Objects/completo.tres")
var venta := false


func _ready():
	var sprite := get_node("Sprite2D")
	sprite.texture = preload("res://Assets/Sprites/objects/objects_32/completo_pescado.png")
