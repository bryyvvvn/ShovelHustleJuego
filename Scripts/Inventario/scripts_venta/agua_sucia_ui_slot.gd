...
var object_data : objectData = preload("res://Assets/Recursos/Objects/agua_sucia.tres")
var venta := false


func _ready():
	var sprite := get_node("Sprite2D")
	sprite.texture = preload("res://Assets/Sprites/objects/objects_32/agua(sucia).png")
